...
export default class InventoryModal extends Component {
  ...
  handleDelete = (event) => {
    ...
    axios
      .delete(`/inventory/${this.props.id}`)
      .then((res) => {
        ...
        <div className='modal'>
          <div className='modal__contents'>
            <div>
              ...
              <p>
                Please confirm that you'd like to delete the {this.props.item}{' '}
            ...
            <div className='modal-btn-tray'>
              <button
                className='btn btn-white btn-modal'
              ...
              <Link
                to='/inventory'
                className='btn btn-red btn-modal btn-link'
