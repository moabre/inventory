    ...
    render() {
        return (
            <main className="mains">
                ...
                <div className="search__title"><h1>Inventory</h1></div>
                <MainFormInventory page={'Item'}/>
                </div>
                <InventoryHeader inventoryPage = {true} fifthElement = {true}/>
                <InventoryList inventory={this.state.inventory} id = {this.state.inventory.id} isVisible = {this.state.isModalVisible} showModal ={this.showModal}/>
                <InventoryModal isVisible={this.state.isModalVisible} hideModal={this.hideModal} updateList = {this.updateList} item={this.state.item} id={this.state.id}/>
            </main>
        )
    }
}
