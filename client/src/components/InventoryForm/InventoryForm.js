...
class InventoryForm extends React.Component {
    ...
    state = {
        ...
        quantityError: false,
        showQuantity: (this.props.data) ? ((this.props.data.status === "In Stock") ? true : false) : true,
        showSuccess: false,
    }
    ...
    handleSubmit = (e) => {
        ...
        if (warehouseName === "default" || !itemName || !description || category === "default" || quantity === "") {
            return
        } else if (this.props.match.params.id) {
            axios.put(`http://localhost:8080/inventory/${this.props.match.params.id}`, newInventory)
                .then(res => {
                    this.setState({
                        showSuccess: true
                    })
        ...
        return (
                <div className="inv-form">
                    <div className="inv-form-header">
                        ...
                        <h1 className="inv-form-title">{(this.props.match.params.id) ?"Edit Inventory Item" : "Add New Inventory Item"}</h1>
                    ...
                    <form onSubmit={this.handleSubmit} noValidate>
                        <div className="form-split">
                            <div className="inv-details">
                                ...
                                label="Category" 
                                type="category" 
                                selected={(this.props.data) ? (this.props.data.category) : "default"}/> :
                                <Select 
                                label="Category" 
                                type="category" 
                                selected={(this.props.data) ? (this.props.data.category) : "default"}/>
                            ...
                            <div className="inv-avail">
                                ...
                                <div className="inv-radio">
                                    ...
                                    <div className="radio-input">
                                        <div className="radio-wrapper">
                                            ...
                                            <label className="radio" htmlFor="In Stock">In Stock</label>
                                        </div>
                                        <div className="radio-wrapper">
                                            <input 
                                            id="InventoryStatus" 
                                            ...
                                            onChange={this.onChange}/>
                                            <label className="radio" htmlFor="Out of Stock">Out of stock</label>
                                        </div>
                                    </div>    
                                </div>
                                {(this.state.showQuantity) ? 
                                (this.state.quantityError) ? (<Input
                                    invalid 
                                    type="number"
                                ...
                                <Select
                                invalid 
                                data={(this.state.warehouseData) ? this.state.warehouseData : ["Loading"]}
                                label="Warehouse" 
                                selected={(this.props.data) ? (this.props.data.warehouseName + "/" + this.props.data.warehouseID) : "default"}/> :
                                <Select 
                                data={(this.state.warehouseData) ? this.state.warehouseData : ["Loading"]}
                                label="Warehouse" 
                                selected={(this.props.data) ? (this.props.data.warehouseName + "/" + this.props.data.warehouseID) : "default"}/>
                        ...
                        <div className="inv__btn-container">
                            <Button type="button" color="white" handleClick={this.goBack} text="Cancel"/>
                            
                            <Button type="submit" color="blue" text={(this.props.data) ? "Save" : "+ Add Item"}/>
                        </div>
