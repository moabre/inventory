        ...
        return (
            <div className="invCard">
                <div className="invCard__header">
                    ...
                    <h1 className="invCard__header-title">{this.state.itemInfo.itemName}</h1>
                    <Link to={{pathname: `/inventory/${this.props.match.params.id}/edit`,
                            state: {
                    ...
                    <div className="invCard__split">
                        <div className="invCard__left">
                            <div className="invCard__desc">
                                ...
                                <p className="invCard__fill">{this.state.itemInfo.description}</p>
                            </div>
                        ...
                        <div className="invCard__right">
                            <div className="invCard__stock">
                                <div className="invCard__status">
                                    ...
                                    {(this.state.itemInfo.status === "In Stock") ? <InStock/> : <OutStock />}
                                </div>
                                <div className="invCard__quantity">
                                    <h4 className="invCard__label">QUANTITY:</h4>
                                    <p className="invCard__fill">{this.state.itemInfo.quantity}</p>
                                </div>
                            </div>
                            <div className="invCard__warehouse">
                                <h4 className="invCard__label">WAREHOUSE</h4>
                                <p className="invCard__fill">{this.state.itemInfo.warehouseName}</p>
                            </div>
                        </div>
                    </div>
                </div>
