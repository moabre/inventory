...
class WarehouseForm extends Component {
  constructor(props) {
    super(props);
    const { id, name, address, city, country, contact } =
  ...
  handleSubmitForm = (e) => {
    ...
    if (this.validate()) {
      ...
      if (this.state.isEdit) {
        //PUT query
        axios
          .put(`/warehouse/edit/${this.state.id}`, newWarehouse)
          .then((res) => {
            this.setState(
              {
                showSuccess: true,
      ...
      <div className='main-content'>
        <div className='warehouse-form-header'>
          <img
            ...
            alt='back-arrow'
          />
          <h2 className='warehouse-form-header__title'>
            {this.state.isEdit ? 'Edit' : 'Add'} Warehouse
          </h2>
        </div>
            ...
            <div className='warehouse-details'>
              ...
              <div className='warehouse-details__input-wrapper'>
                ...
                {this.state.errors.name ? (
                  <div className='warehouse-details__condition'>
                    <Required />
                  </div>
                ) : null}
              </div>
              ...
              <div className='warehouse-details__input-wrapper'>
                <input
                  ...
                  className={`${this.getClassName(
                    'country'
                  )} warehouse-details__input--last`}
                  name='country'
                  value={this.state.country}
                  onChange={this.handleInputChange}
                />
                {this.state.errors.country ? (
                  <div className='warehouse-details__condition--last'>
                    <Required />
                  </div>
                ) : null}
              </div>
          ...
          <div className='form__button-tray'>
            <div className='form__buttons'>
              <Button
                color='white'
                text='Cancel'
                handleClick={this.handleCancelBtn}
              />
              {submitButton}
            </div>
          </div>
